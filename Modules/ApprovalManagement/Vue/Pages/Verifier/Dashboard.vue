...
const tabs = [
    { key: 'pending', label: 'Pending', get count() { return props.pendingApplications.total; } },
    { key: 'verified', label: 'Verified by you', get count() { return props.verifiedByMe.total; } },
];

const applySearch = () => {
    router.get(route('verifier.dashboard'), { q: search.value || undefined }, {
        preserveState: true,
        preserveScroll: true,
        replace: true,
    });
...
<template>
    ...
    <PanelLayout>
        ...
        <div class="max-w-5xl mx-auto space-y-6">
            <div>
                <h3 class="text-lg font-semibold text-slate-900">Application verification</h3>
            ...
            <section v-show="activeTab === 'verified'" class="space-y-4">
                <p
